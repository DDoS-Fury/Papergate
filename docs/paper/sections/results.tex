...
Two operational distinctions separate this protocol from prior work: snapshot models discretize
streams into fixed time windows, whereas an authorization PDP must evaluate requests
synchronously upon arrival; and static offline evaluations ignore commit gating, leaving streaming
models vulnerable to baseline poisoning.
