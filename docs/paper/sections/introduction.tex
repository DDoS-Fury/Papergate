...
corpus~\cite{lanl} as the benchmark. Although dynamic link prediction is well explored
for lateral movement, existing systems operate on substrates that omit contextual signals
already available at a Zero Trust policy decision point (PDP).
...
\begin{enumerate}
  ...
  \item \textit{An automated leakage audit for synthetic benchmarks.} To prevent
