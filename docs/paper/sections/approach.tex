...
path of the principal. Five edges are emitted per request (Fig.~\ref{fig:chain}): the four bindings
...
chain. The arming threshold is the label-free clean-FPR quantile of
Section~\ref{sec:approach}; arming feeds the prior alone, while the trust feature and the
