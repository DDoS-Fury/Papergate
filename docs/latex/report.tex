...
\hline
AUC aggregata              & \textbf{0.946} & 0.893 & 0.725 \\
AP aggregata               & \textbf{0.743} & 0.700 & 0.181 \\
Recall @soglia             & \textbf{0.815} & 0.655 & 0.139 \\
\hline
Policy --- AUC             & 0.991 & 0.992 & 0.875 \\
Contextual --- AUC         & 0.999 & 0.998 & 0.772 \\
Lateral --- AUC            & \textbf{0.849} & 0.689 & 0.532 \\
Lateral --- Recall @soglia & \textbf{0.503} & 0.088 & 0.044 \\
\hline
\end{tabular}
\caption{Confronto sul test set (FPR benigno calibrato all'1\%). Le anomalie \textit{policy} e \textit{contextual} --- separabili rispettivamente su attributi statici e su edge feature --- sono colte anche dalla GNN statica, che infatti pareggia il TGN. Il vantaggio del TGN si concentra quasi interamente sul \textbf{lateral movement}: pur addestrata con lo stesso hard-negative, la GNN statica resta a Recall 8.8\% (AUC 0.689), contro 50.3\% (AUC 0.849) del TGN. È la prova empirica che a discriminare l'accesso autorizzato-ma-non-abituale è la \emph{cronologia temporale} delle interazioni e non il solo curriculum di addestramento; un grafo statico aggregato, che ne appiattisce la sequenza, non basta.}
\label{tab:baselines}
\end{table}
